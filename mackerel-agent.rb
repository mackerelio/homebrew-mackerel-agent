class MackerelAgent < Formula
  ...
  if Hardware::CPU.is_64_bit?
    url 'https://github.com/mackerelio/mackerel-agent/releases/download/v0.43.1/mackerel-agent_darwin_amd64.zip'
    sha256 '8ce04156f80e2015fe6e45afa16905b2173589890323e83a407159c8510da84b'
  else
    url 'https://github.com/mackerelio/mackerel-agent/releases/download/v0.43.1/mackerel-agent_darwin_386.zip'
    sha256 '23fe4602f811941b2eccad50b5af134a73193a75de80bb6ea32e5583f658deac'
  end
